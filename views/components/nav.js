...
const createNavHome = () => {
  ...
  <div class="max-w-7xl h-16 mx-auto flex items-center px-4 justify-between">
    ...
    <!-- version movil -->
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 md:hidden text-white cursor-pointer hover:bg-green-600 rounded-lg">
      <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
    </svg>

    <!-- version escritorio -->
    <div class="hidden md:flex flex-row gap-4">
      <a href="/login/" class="transition ease-in-out text-white font-bold hover:bg-green-600 py-2 px-4 rounded-lg">Login</a>
      <a href="/signup/" class="transition ease-in-out text-white font-bold bg-green-300 hover:bg-green-600 py-2 px-4 rounded-lg">Sign Up</a>
    </div>
...
const createNavTodos = () => {
  ...
  <div class="max-w-7xl h-16 mx-auto flex items-center px-4 justify-between">
    ...
    <!-- version escritorio -->
    <div class="hidden md:flex flex-row gap-4">
      <button id="close-btn" class="transition ease-in-out text-white font-bold bg-green-300 hover:bg-green-600 py-2 px-4 rounded-lg">Cerrar Sesión</button>
    </div>
